 ...
 */
final class Version20220225084019 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE event DROP time, CHANGE date date DATETIME NOT NULL');
    }
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE event ADD time TIME NOT NULL, CHANGE title title VARCHAR(50) NOT NULL COLLATE `utf8mb4_unicode_ci`, CHANGE type type VARCHAR(32) NOT NULL COLLATE `utf8mb4_unicode_ci`, CHANGE date date DATE NOT NULL, CHANGE description description LONGTEXT NOT NULL COLLATE `utf8mb4_unicode_ci`');
